...
1. Página Pessoal Crie uma página de apresentação sobre você. Inclua seu nome, uma breve biografia, uma imagem sua ou de algo que represente você, uma lista com seus hobbies e links para sites que você gosta ou perfis sociais.

2. Filme ou Série Favorita Crie uma página sobre um filme ou série que você gosta. Descreva a história, coloque uma imagem do pôster ou personagens, faça uma lista de motivos para assistir e adicione links para trailers ou mais informações.

3. Top 3 Jogos Favoritos Monte uma lista dos seus 3 jogos preferidos. Para cada jogo, escreva um parágrafo explicando por que gosta dele, coloque uma imagem ou logo do jogo, e adicione links para trailers ou sites oficiais.
...
Cabeçalho (título principal e navegação).
Conteúdo principal (seções, artigos e artigos relacionados).
Conteúdo tangencial (a dica rápida).
Rodapé (último parágrafo).
